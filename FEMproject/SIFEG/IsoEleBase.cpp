...
SIFEG::IsoEleBase::IsoEleBase(int nNode, PhyFieldData* pData /*= nullptr*/) :EleSubBase(nNode, pData)
{

}

SIFEG::IsoEleBase::~IsoEleBase()
{

}

int SIFEG::IsoEleBase::shapn(int iGause, std::vector<double>& coor, std::vector<std::vector<double>>& crtr, std::vector<std::vector<double>>& cu)
{
	cu.resize(_nNode);
...
int SIFEG::IsoEleBase::shapc(int iGause, int nVal, std::vector<std::vector<double>>& dfdx, std::vector<std::vector<double>>& crtr, std::vector<std::vector<double>>& cu, int dord)
{
...
std::vector<double> SIFEG::IsoEleBase::coordTransFun(const std::vector<double>& _coorr, const std::vector<double>& refc)
{
...
int SIFEG::IsoEleBase::dcoor(const std::vector<double>& r, int iGaus, std::vector<double>& fx, std::vector<std::vector<double>>& dfdx, int dord)
{
	int n = _nRefc;
...
int SIFEG::IsoEleBase::dCoef(const std::vector<double>& x, int iGaus, int nVal, std::vector<double>& fx, std::vector<std::vector<double>>& dfdx, int dord /*= 1*/)
{
...
int SIFEG::IsoEleBase::dshap(int iGaus, std::vector<double>& fx, std::vector<std::vector<double>>& dfdx, int dord)
{
	//int n = x.size();
	//fx = shapeFun(x);
	//int m = fx.size();
...
int SIFEG::IsoEleBase::caculateShapeCoef(int dim)
{
	_iPow3 = pow(3, dim);
	int iPow3 = _iPow3;
	for (int i = 0; i < dim; ++i)
...
std::vector<double> SIFEG::IsoEleBase::coordTransFun(const std::vector<double>& x, int nVal, int iGaus, int i)
{
	int iVal = -1;
